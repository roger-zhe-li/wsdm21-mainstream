...
for i in range(len(datasets)):
	...
	for k in range(1, 11):
		...
		for j in range(8):
			...
			if j == 7:
				...
				bin_0.append(bin0[gain_ind[k-1]]-bin0[0])
				bin_1.append(bin1[gain_ind[k-1]]-bin1[0])
				bin_2.append(bin2[gain_ind[k-1]]-bin2[0])
				bin_3.append(bin3[gain_ind[k-1]]-bin3[0])
	...
	seeds = [1, 777, 1234, 1476, 1573, 1771, 1842, 1992, 2003, 2020]
	for j in range(10):
		bin_gains.append([dataset, seeds[j], bin_0[j], bin_1[j], bin_2[j], bin_3[j]])

header = ['dataset', 'seed', 'bin0', 'bin1', 'bin2', 'bin3']
