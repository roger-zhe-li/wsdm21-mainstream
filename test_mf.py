...
from model import DeepCoNNTrainTest, FMTrainTest, MFTrainTest
import os
import yaml
...
parser = argparse.ArgumentParser(description='hyperparameters for MF.')
...
parser.add_argument('--lr', type=float, default=0.01,
					help='learning rate')
parser.add_argument('--review_length', type=int, default=100,
...
parser.add_argument('--mf_k', type=int, default=100,
...
def mf():
	...
	# 训练模型
	train_test = MFTrainTest(epoch=args.epochs,
